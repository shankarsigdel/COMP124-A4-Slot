...
(function () {
    ...
    let bet1Button;
    let betMaxButton;
    let rePayToPlayButton;
    let stopOrResumeGameButton;
    //About the Labels
    let jackPotLabel;
    let creditLabel;
    let winningsLabel;
        ...
        if (reels.indexOf('blank') > -1) {
            ...
            if (duplicateNum >= 2) {
                switch (duplicatedSymbol) {
                    case 'grapes':
                        multiplicitationNumber = 10;
                        break;
                    case 'banana':
                        multiplicitationNumber = 20;
                        break;
                    case 'orange':
                        multiplicitationNumber = 30;
                        break;
                    case 'cherry':
                        multiplicitationNumber = 40;
                        break;
                    case 'bar':
                        multiplicitationNumber = 50;
                        break;
                    case 'bell':
                        multiplicitationNumber = 75;
                        break;
                    case 'seven':
                        multiplicitationNumber = 100;
                        break;
                    default:
                        multiplicitationNumber = 1;
                        break;
                }
            }
            // If the two symbols are the same then, ...
                ...
                switch (duplicatedSymbol) {
                    case 'grapes':
                        multiplicitationNumber = 2;
                        break;
                    case 'banana':
                        multiplicitationNumber = 3;
                        break;
                    case 'orange':
                        multiplicitationNumber = 4;
                        break;
                    case 'cherry':
                        multiplicitationNumber = 5;
                        break;
                    case 'bar':
                        multiplicitationNumber = 7;
                        break;
                    case 'bell':
                        multiplicitationNumber = 9;
                        break;
                    case 'seven':
                        multiplicitationNumber = 29;
                        break;
                    default:
                        multiplicitationNumber = 1;
                        break;
    ...
    function interfaceLogic() {
        ...
        spinButton.on('click', () => {
            if (playerBet > 0) {
                ...
                leftReel.image =
                    assets.getResult(reels[0]);
                middleReel.image =
                    assets.getResult(reels[1]);
                rightReel.image =
                    assets.getResult(reels[2]);
                playerBet = 0;
                betLabel.setText(playerBet.toString());
                jackpot = 0;
                jackPotLabel.setText(jackpot.toString());
